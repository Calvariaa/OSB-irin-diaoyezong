...
namespace StorybrewScripts
{
    public class ParticlesOld : StoryboardObjectGenerator
    {
        ...
        [Configurable]
        public Color4 Color2 = new Color4(1, 1, 1, 0.6f);
        ...
        {
            smallight1(44845, 54391);
            smallight2(44845, 54391);

            smallight1(224831 + 14, 243922 + 14);
            smallight2(224831 + 14, 243922 + 14);

            smallight1(312104 + 14, 323013 + 14);
            smallight2(312104 + 14, 323013 + 14);
        }


        public void smallight1(int StartTime, int EndTime) //44845 54391 224831 243922
        {
        ...
        public void smallight2(int StartTime, int EndTime)
        {
            StartTime += 227;
            EndTime -= 227;
            if (StartTime == EndTime)
            ...
            using (var pool = new OsbSpritePool(layer, Path, Origin, (sprite, startTime, endTime) =>
            {
                ...
                if (Color2.R < 1 || Color2.G < 1 || Color2.B < 1)
                    sprite.Color(startTime, Color2);

                if (Color2.A < 1)
                    sprite.Fade(startTime, Color2.A);
            ...
            }))
            {
                ...
                for (var startTime = (double)StartTime; startTime <= EndTime - particleDuration; startTime += timeStep)
                {
                    ...
                    if (FadeInDuration > 0 || FadeOutDuration > 0)
                    {
                        ...
                        sprite.Fade(easing, startTime, Math.Max(startTime, fadeInTime), 0, Color2.A);
                        sprite.Fade(easing, Math.Min(fadeOutTime, endTime), endTime, Color2.A, 0);
                    }
