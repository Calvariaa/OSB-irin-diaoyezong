...
namespace StorybrewScripts
{
    public class Particles : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            run(115740, 148468 - (int)Lifetime);
            run(257559, 301195 - (int)Lifetime);
        }
        ...
        public void run(int StartTime, int EndTime)
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                */
                ...
                particle.Scale(Easing, 0, loopDuration, 0.15, 0.2);
                ...
                particle.Rotate(Easing, loopDuration * 0.5, loopDuration, MathHelper.DegreesToRadians(-90), MathHelper.DegreesToRadians(0));
